 ...
 * Módulo de Consolidado y Reportes Gerenciales (sys_v1_reportes.js)
 * Sincronizado al 100% con Cloud Firestore
 */
...
async function inicializarReportes() {
    mostrarStatusBar("⏳ Calculando métricas gerenciales...", "loading");
    ...
    try {
        ...
        onSnapshot(productosCollection, (snapshot) => {
            ...
            snapshot.forEach(doc => {
                ...
                // Solo calculamos sobre productos con stock positivo para no desvirtuar la inversión real actual
                if (stock > 0) {
            ...
            mostrarStatusBar("✅ Métricas gerenciales actualizadas en tiempo real.", "success");
        }, (error) => {
        ...
        console.error("Error crítico en módulo reportes:", e);
...
// ==========================================
function renderizarMetenciales(costo, venta, ganancia, items, unidades) {
    // Formatear a USD
...
// Forzar mapeo del nombre corregido por compatibilidad
const renderizarMetricasGerenciales = renderizarMetenciales;
